<template>
  ...
  <div class="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8">
    ...
    <div class="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8">
      <div class="group relative" v-for="product in data.products">
        ...
        <div class="mt-4 flex justify-between">
          ...
          <p class="text-sm font-medium text-gray-900">{{ product.price }} บาท</p>
...
<script setup>
const { data: data } = await useFetch('https://dummyjson.com/products/category/smartphones')
</script>
